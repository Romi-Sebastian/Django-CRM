...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'website.context_processors.unread_notifications_context',
            ],
        },
    },
]
...
# postgresql://django_crm_render_user:2613Jxnvd1vyWBjDn0GlXKCKmpQS1NMB@dpg-d0gdq5a4d50c73foemf0-a.oregon-postgres.render.com/django_crm_render
...
DEFAULT_FROM_EMAIL = 'noreply@examplecrm.com'
